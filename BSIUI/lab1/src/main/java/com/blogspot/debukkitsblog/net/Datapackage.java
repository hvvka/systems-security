...
public class Datapackage extends ArrayList<Object> {
     ...
     *
     * @param id The ID used by the remote application to identify the package
     * @param o  The payload
     */
     ...
     * @param senderGroup The name of the group the sender is member of
     */
    ...
    public boolean equals(Object o) {
        ...
        Datapackage objects = (Datapackage) o;

        if (senderID != null ? !senderID.equals(objects.senderID) : objects.senderID != null) return false;
        return senderGroupName != null ? senderGroupName.equals(objects.senderGroupName) : objects.senderGroupName == null;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (senderGroupName != null ? senderGroupName.hashCode() : 0);
        return result;
    }
}